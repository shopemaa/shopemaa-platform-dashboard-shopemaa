...
import {unwrapBusinessCard, unwrapCampaign, unwrapQrCodeConfig} from "../../../../helpers/responseUnwrapper";
import CampaignOverviewTab from "../../../../components/campaigns/CampaignOverviewTab";

export default function BusinessCardIndex({project}) {
    return (<CampaignOverviewTab project={project}/>)
}
