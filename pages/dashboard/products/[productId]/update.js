...
import ProductUpdateForm from "../../../../components/products/ProductUpdate";
    ...
    return (
        <div className="container-xl py-4">
            <div className="d-flex align-items-center mb-3">
                <h1 className="m-0 fw-bold">Update product</h1>
            ...
            <ProductUpdateForm onSubmitPayload={handleSubmitPayload}/>
        </div>
    );
}
