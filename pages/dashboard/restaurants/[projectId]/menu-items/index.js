import MenuItemList from "../../../../../components/restaurant/menu-item/MenuItemList";
import {
    logout,
...
const MenuItemListIndex = ({project}) => {
    return (
        <>
            <MenuItemList project={project}/>
        </>
    )
}

export default MenuItemListIndex
