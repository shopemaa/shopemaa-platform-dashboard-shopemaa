...
import QrCodeConfigure from '../../../../components/qrcode/QrCodeConfigure'
...
import {
    ...
    unwrapMaskedLink,
    unwrapQrCodeConfig
} from "../../../../helpers/responseUnwrapper";
import {handleApi, handleError} from "../../../../common_api";

export default function Configure({project}) {
    return (<QrCodeConfigure project={project}/>)
}
